...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QCheckBox, QComboBox, QDateTimeEdit,
                             ...
                             QToolBar, QVBoxLayout, QWidget, QAction, QMessageBox)
...
class ScoreKeeper(QMainWindow):
    ...
    def combobox(self):
        ...
        combo.addItem('1 Player')
        combo.addItem('2 Player')
        combo.addItem('3 Player')
        combo.addItem('4 Player')


        hbox.addWidget(combo)
        hbox.setSpacing(20)
        combo.setContentsMargins(10,40,10,10)
        combo.move(10,10)
        self.setLayout(hbox)
        self.show()
